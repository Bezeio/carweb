...
<body>
    ...
    <main>
        ...
        <div class="wrapper">
            <div class="carousel owl-carousel">
                ...
                <div class="card card-2">
                    <img src="https://f7.photo.talk.zdn.vn/8241661440093182945/2966bd62cae100bf59f0.jpg">
                </div>
        ...
        <section class="hireme" id="hireme">
            <div class="container">
                <h3 class="title">Chúc các quý khách hàng sẽ có những trải nghiệm vui vẻ!</h3>
            </div>
            <!-- <a href="#" class="btn">Tham khảo ngay</a> -->
        </section>
        <a href="index.php"><button type="button" id="buu" class="btn btn-danger btn-lg ">Quay về trang chủ</button></a>
    </main>
    <hr>
    <?php
